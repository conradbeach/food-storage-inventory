...
RSpec.describe FoodItemsController, type: :controller do
  ...
  # FoodItemsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET #show" do
    it "returns a success response" do
      ...
      get :show, params: { id: food_item.to_param }, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "GET #edit" do
    it "returns a success response" do
      food_item = FoodItem.create! valid_attributes
      get :edit, params: { id: food_item.to_param }, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new FoodItem" do
        expect do
          post :create, params: { food_item: valid_attributes }, session: valid_session
        end.to change(FoodItem, :count).by(1)
      end

      it "redirects to the created food_item" do
        post :create, params: { food_item: valid_attributes }, session: valid_session
        expect(response).to redirect_to(FoodItem.last)
      end
    end

    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: { food_item: invalid_attributes }, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested food_item" do
      food_item = FoodItem.create! valid_attributes
      expect do
        delete :destroy, params: { id: food_item.to_param }, session: valid_session
      end.to change(FoodItem, :count).by(-1)
    end
